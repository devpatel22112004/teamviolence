...
const TournamentCard = memo(({ tournament, onRegister }) => {
  ...
  const getStatus = useCallback(() => {
    ...
    return { label: 'AVAILABLE', color: 'text-primary-400', bg: 'bg-primary-500' }
  }, [filled])

  const getRarity = useCallback(() => {
    if (tournament.badge === 'ELITE' || tournament.prizePool > 50000) {
      return { bg: 'from-purple-600 to-accent-600', border: 'border-purple-500/50', icon: '⭐' }
    }
    if (tournament.badge === 'PRO' || tournament.prizePool > 20000) {
      return { bg: 'from-amber-600 to-orange-600', border: 'border-amber-500/50', icon: '✨' }
    }
    return { bg: 'from-primary-600 to-primary-600', border: 'border-primary-500/50', icon: '🎯' }
  ...
  return (
    ...
    >
      ...
      <div className={`relative bg-gradient-to-br from-slate-900/98 via-slate-950/95 to-black/98 backdrop-blur-lg border-2 ${rarity.border} rounded-[20px] overflow-hidden p-5 sm:p-6 h-full flex flex-col transition-all duration-500 hover:border-white/40 hover:translate-y-[-4px] shadow-2xl hover:shadow-3xl`}>
        ...
        <div className="mb-3.5 flex-1">
          <h3 className="text-xl sm:text-2xl font-black text-white leading-tight mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-primary-400 group-hover:to-purple-400 transition-all duration-300">
            {tournament.title}
          </h3>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-gradient-to-r from-primary-500/20 to-purple-500/20 border border-primary-500/40">
            <div className="w-1.5 h-1.5 rounded-full bg-primary-400" />
            <p className="text-primary-300 font-bold text-xs uppercase tracking-widest">
              {tournament.mode}
            </p>
          </div>
        </div>
        ...
        {tournament.prizeBreakdown && (
          <div className="mb-3.5 relative bg-gradient-to-r from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-[16px] p-4 overflow-hidden">
            <div className="flex items-center justify-between gap-2">
              ...
              {/* Highest Killer */}
              <div className="flex-1 text-center">
                <div className="relative inline-flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-red-500/30 to-accent-500/20 border border-red-500/60 mb-2">
                  <span className="text-lg">🔥</span>
                </div>
        ...
        <div className="grid grid-cols-3 gap-2.5 mb-4 text-center">
          ...
          <div className="relative bg-gradient-to-br from-primary-500/10 to-primary-600/5 border border-primary-500/30 rounded-xl p-3 backdrop-blur-sm overflow-hidden group/stat hover:border-primary-400/50 transition-all">
            <FaUsers className="relative mx-auto text-primary-400 mb-1.5 text-lg group-hover/stat:scale-110 transition-transform" />
          ...
          <div className="relative bg-gradient-to-br from-accent-500/10 to-accent-600/5 border border-accent-500/30 rounded-xl p-3 backdrop-blur-sm overflow-hidden group/stat hover:border-accent-400/50 transition-all">
            <FaCalendar className="relative mx-auto text-accent-400 mb-1.5 text-lg group-hover/stat:scale-110 transition-transform" />
        ...
        <div className="mb-3.5 flex items-center justify-between gap-2 rounded-xl bg-primary-500/5 border border-primary-500/20 px-3 py-2">
          <span className="text-gray-400 font-black text-[10px] uppercase tracking-widest">Starts In</span>
          <Countdown date={tournament.date} compact />
        </div>
        ...
        <div className="mb-3.5">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-purple-400 font-black text-sm">
          ...
          <div className="relative w-full bg-slate-800/80 rounded-full h-2.5 overflow-hidden border border-slate-700/80 shadow-inner">
            <motion.div
              ...
              className="h-full bg-gradient-to-r from-primary-500 via-purple-500 to-accent-500 relative overflow-hidden"
            >
        ...
        <div className="mb-4">
          {tournament.type === 'free' ? (
            ...
            <div className="relative inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black bg-gradient-to-r from-purple-500/25 to-accent-500/25 text-purple-200 border border-purple-500/70 w-full justify-center overflow-hidden group/entry shadow-lg">
        ...
        <button
          ...
          className={`relative w-full font-black py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 uppercase tracking-wider text-xs overflow-hidden group/btn ${
            isFull
              ...
              : 'bg-gradient-to-r from-primary-600 via-primary-600 to-purple-600 hover:from-primary-500 hover:via-primary-500 hover:to-purple-500 text-white shadow-xl shadow-primary-500/40 hover:shadow-primary-500/60 active:scale-98 border border-primary-400/50 hover:border-primary-300/70'
...
const StatCard = memo(({ icon: Icon, label, value, color }) => (
  ...
  >
    ...
    {/* Card */}
    <div className="relative bg-gradient-to-br from-slate-900/95 via-slate-950/90 to-black/95 backdrop-blur-md border-2 border-white/10 rounded-2xl p-6 sm:p-7 text-center group-hover:border-white/30 transition-all duration-300 shadow-2xl">
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-20 bg-gradient-to-br from-slate-900 via-slate-950 to-black">
        <motion.div
          ...
          className="w-16 h-16"
        >
          <FaTrophy className="w-full h-full text-primary-500 opacity-50" />
        </motion.div>
      </div>
    )
  }
    ...
    <div className="pt-20 pb-20 bg-gradient-to-br from-slate-950 via-slate-900 to-black min-h-screen will-change-auto">
      ...
      <section className="relative py-28 sm:py-32 overflow-hidden px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-primary-500/15 rounded-full blur-[120px] pointer-events-none animate-pulse" />
          <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-purple-500/15 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-accent-500/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center justify-center space-x-3 px-6 sm:px-8 py-3 rounded-full backdrop-blur-md bg-gradient-to-r from-primary-500/20 via-purple-500/20 to-accent-500/20 border-2 border-primary-500/50 shadow-2xl shadow-primary-500/30"
            >
              <FaFire className="text-primary-400 text-xl animate-pulse" />
              <span className="text-primary-200 font-black text-sm sm:text-base tracking-[0.2em] uppercase">Premium Tournaments</span>
            ...
            >
              ...
              <span className="block bg-gradient-to-r from-primary-400 via-purple-400 to-accent-400 bg-clip-text text-transparent mt-3">
                BATTLE GROUND
              </span>
            </motion.h1>
            ...
            >
              ...
              <button
                ...
                className="relative px-10 py-4 rounded-2xl font-black text-base overflow-hidden group active:scale-95 transition-all shadow-2xl"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-accent-600 group-hover:from-purple-500 group-hover:to-accent-500 transition-all" />
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
                <div className="relative flex items-center justify-center space-x-2.5 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 sm:-mt-20 mb-24 relative z-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
          <StatCard icon={FaFire} label="Live Events" value={stats.liveCount} color="from-orange-500 via-red-500 to-accent-600" />
          ...
          <StatCard icon={FaUsers} label="Total Slots" value={stats.totalSlots} color="from-primary-500 via-primary-500 to-purple-600" />
          <StatCard icon={FaStar} label="Game Modes" value="4+" color="from-purple-500 via-accent-500 to-rose-600" />
        </div>
      </section>
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-between items-start sm:items-center">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { value: 'paid', label: '🏆 Premium', gradient: 'from-purple-600 to-accent-600' },
            ].map((tab) => (
              <button
                key={tab.value}
          ...
          <select
            ...
            className="px-4 py-2.5 rounded-lg bg-slate-800 border border-slate-700 text-gray-200 font-bold text-sm focus:outline-none focus:border-primary-500 transition-all"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl p-8 sm:p-12 bg-gradient-to-r from-primary-600/20 via-purple-600/20 to-accent-600/20 border border-primary-500/30 group"
        >
          <div className="absolute inset-0 -z-10 pointer-events-none">
            <div className="absolute top-0 right-0 w-96 h-96 bg-primary-500/20 blur-3xl opacity-0 group-hover:opacity-30 transition-opacity duration-300" />
          </div>

          <div className="relative text-center space-y-6">
            <div className="text-5xl">🚀</div>
            <h2 className="text-3xl sm:text-4xl font-black text-white">
              Ready to <span className="bg-gradient-to-r from-primary-400 to-purple-400 bg-clip-text text-transparent">DOMINATE?</span>
            </h2>
            ...
            <button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-600 hover:from-primary-500 hover:to-primary-500 text-white font-black rounded-xl text-lg transition-all shadow-lg shadow-primary-500/40 active:scale-95"
            >
              <FaArrowRight />
              BACK TO TOP
            </button>
        ...
        {showRegisterModal && selectedTournament && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-primary-500/30"
            >
              <div className="bg-gradient-to-r from-primary-600 to-purple-600 p-6 sm:p-8 flex items-center justify-between sticky top-0 z-10">
                <div>
                  <h2 className="text-2xl sm:text-3xl font-black text-white">{selectedTournament.title}</h2>
                  <p className="text-primary-100 text-sm font-bold mt-1 uppercase">{selectedTournament.mode}</p>
                </div>
                <button
                  onClick={handleCloseModal}
              ...
              <div className="p-6 sm:p-8 space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="bg-slate-700/60 border border-primary-500/30 rounded-lg p-4 text-center">
                  ...
                  <div className="bg-slate-700/60 border border-accent-500/30 rounded-lg p-4 text-center">
                    <p className="text-gray-400 text-xs font-bold uppercase mb-1">SLOTS</p>
                    <p className="text-accent-300 text-lg font-black">{selectedTournament.totalSlots - selectedTournament.registeredTeams}</p>
                  </div>
                ...
                {selectedTournament.specialNote && (
                  <div className="bg-primary-500/20 border border-primary-500/50 rounded-lg p-4">
                    <p className="text-primary-300 font-bold text-center">{selectedTournament.specialNote}</p>
                  </div>
                )}
                ...
                {user ? (
                  <form onSubmit={handleRegister} className="space-y-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-700/60 border-2 border-primary-500/30 focus:border-primary-500 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none transition-all"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleFormChange}
                          className="w-full bg-slate-700/60 border-2 border-accent-500/30 focus:border-accent-500 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none transition-all resize-none"
                        ...
                        <div className="bg-gradient-to-r from-amber-500/30 to-orange-500/30 border-2 border-amber-500/70 rounded-lg p-5 space-y-3">
                          ...
                          <div className="bg-black/30 rounded-lg p-4 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <a href="https://www.instagram.com/teamviolenceesports?igsh=MTRhOTRzMDR4aHQ2Mw==" target="_blank" rel="noopener noreferrer" className="bg-accent-600 hover:bg-accent-500 text-white font-bold py-2 px-3 rounded-lg text-center text-sm flex items-center justify-center gap-2 transition-all">
                                <span>📷</span> Instagram
                              </a>
                              ...
                              <a href="https://discord.gg/amN9D8SrN8" target="_blank" rel="noopener noreferrer" className="bg-primary-600 hover:bg-primary-500 text-white font-bold py-2 px-3 rounded-lg text-center text-sm flex items-center justify-center gap-2 transition-all">
                                <span>⚡</span> Discord
                              </a>
                            </div>
                  ...
                  <div className="bg-red-500/20 border-2 border-red-500/50 rounded-xl p-6 text-center space-y-4">
                    ...
                    <Link to="/login" className="inline-block w-full bg-gradient-to-r from-red-600 to-accent-600 hover:from-red-500 hover:to-accent-500 text-white font-black py-3 rounded-lg transition-all uppercase">
                      Go to Login
                    </Link>
                  </div>
                )}
